    ...
    [
      {
        ...
        desc: "The store, the local setting, and the organization currently highlighted by OneMoreGood.",
        Icon: ShieldCheck,
      },
      {
      ...
      },
      {
        ...
        desc: "Small organizations can move further when a successful business shares part of its net profits with practical operational needs.",
        Icon: ShieldCheck,
      },
    ]
    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-14">
        <SectionTitle
          ...
          desc="This page explains which organization OneMoreGood currently supports, why that work matters, and how our giving model is structured."
        />
          ...
          <div className="md:col-span-4">
            ...
            >
              ...
              <div className="mt-6 text-sm" style={{ color: colors.muted }}>
                ...
                current featured organization we support with part of the
                profits generated by product sales.
                <br />
                <br />
                If you want to discuss orders, wholesale, collaborations,
                product ideas, or the brand&apos;s giving model, contact us
