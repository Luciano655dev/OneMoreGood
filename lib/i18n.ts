...
export const i18n = {
  en: {
    ...
    checkout: {
      title: "Checkout",
      unavailable: "Online checkout is temporarily unavailable.",
      brOnly: "Online checkout is available for Brazil orders only.",
      ...
      cep: "CEP",
      cepLookup: "Looking up address…",
      cepError: "Couldn't find that CEP. Check the number.",
      street: "Street",
      number: "Number",
      ...
      shippingHint: "Enter a valid CEP to see PAC and SEDEX prices.",
      calculating: "Calculating shipping…",
      quoteError: "Couldn't calculate shipping. Try again.",
      days: (n: number) => `up to ${n} business days`,
      ...
      selectShipping: "Please choose a shipping method.",
      secured: "Payment is processed securely by Stripe.",
    },
  },
  pt: {
    nav: {
    ...
    checkout: {
      ...
      unavailable: "O checkout online está indisponível no momento.",
      brOnly: "O checkout online está disponível apenas para pedidos no Brasil.",
      emptyCart: "Seu carrinho está vazio.",
      backToShop: "Voltar para a loja",
      contactHeading: "Seus dados",
      fullName: "Nome completo",
      email: "Email",
      phone: "Telefone",
      cpf: "CPF",
      addressHeading: "Endereço de entrega",
      cep: "CEP",
      cepLookup: "Buscando endereço…",
      cepError: "CEP não encontrado. Verifique o número.",
      street: "Rua",
      number: "Número",
      ...
      city: "Cidade",
      state: "Estado",
      shippingHeading: "Forma de envio",
      shippingHint: "Informe um CEP válido para ver os preços de PAC e SEDEX.",
      calculating: "Calculando o frete…",
      quoteError: "Não foi possível calcular o frete. Tente novamente.",
      days: (n: number) => `até ${n} dias úteis`,
      summaryHeading: "Resumo do pedido",
      subtotal: "Subtotal",
      shipping: "Frete",
      total: "Total",
      pay: "Pagar agora",
      paying: "Processando…",
      payError: "Não foi possível concluir o pagamento. Tente novamente.",
      missingFields: "Preencha todos os campos obrigatórios.",
      selectShipping: "Escolha uma forma de envio.",
      secured: "O pagamento é processado com segurança pela Stripe.",
    },
  },
} as const
